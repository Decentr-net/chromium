...
// Boolean preference that triggers decentr://settings/androidApps/details to be
// opened on user session start.
const char kShowArcSettingsOnSessionStart[] =
    "start_arc_settings_on_session_start";

// Boolean preference that triggers decentr://settings/syncSetup to be opened
...
// Boolean that indicates whether decentr://accessibility should show the
...
// page (decentr://settings/importData).
...
// remote debugging at decentr://inspect.
