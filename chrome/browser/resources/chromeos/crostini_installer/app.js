...
import 'decentr://resources/cr_elements/cr_slider/cr_slider.js';
...
import 'decentr://crostini-installer/strings.m.js';
import 'decentr://resources/cros_elements/button/button.js';
import 'decentr://resources/cr_elements/hidden_style_css.m.js';

import {BrowserProxy} from 'decentr://crostini-installer/browser_proxy.js';
...
Polymer({
  ...
  onSettingsButtonClick_() {
    window.open('decentr://os-settings/help');
  },
