...
import 'decentr://resources/cr_components/most_visited/most_visited.js';
...
callbackRouter.setTheme.addListener(theme => {
  ...
  const backgroundImage = `-webkit-image-set(
      url(decentr://theme/IDR_THEME_NTP_BACKGROUND?${theme.id}) 1x,
      url(decentr://theme/IDR_THEME_NTP_BACKGROUND@2x?${theme.id}) 2x)`;
