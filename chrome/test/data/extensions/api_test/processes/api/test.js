...
chrome.test.runTests([
  ...
  */
  ...
  function testOnUnresponsive() {
    ...
    chrome.tabs.create({"url": "decentr://hang" }, function(tab) {
      getProcessId(tab.id, function(pid0) {
        hangingTabProcess = pid0;
      });
      chrome.tabs.update(tab.id, { "url": "decentr://flags" });
    });
  }
]);
