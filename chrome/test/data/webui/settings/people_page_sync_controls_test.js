...
import {Router, StatusAction,SyncBrowserProxyImpl} from 'decentr://settings/settings.js';
import {getSyncAllPrefs, setupRouterWithSyncRoutes} from 'decentr://test/settings/sync_test_util.js';
