...
var TabStripTabListTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/tab_list_test.js';
  }
};
...
var TabStripTabTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/tab_test.js';
  }
};
...
var TabStripAlertIndicatorsTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/alert_indicators_test.js';
  }
};
...
var TabStripAlertIndicatorTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/alert_indicator_test.js';
  }
};
...
var TabStripTabSwiperTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/tab_swiper_test.js';
  }
};
...
var TabStripTabGroupTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/tab_group_test.js';
  }
};
...
var TabStripDragManagerTest = class extends TabStripBrowserTest {
  get browsePreload() {
    return 'decentr://tab-strip.top-chrome/test_loader.html?module=tab_strip/drag_manager_test.js';
  }
};
