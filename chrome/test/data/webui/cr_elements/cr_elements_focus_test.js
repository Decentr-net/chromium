...
var CrElementsActionMenuTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test?module=cr_elements/cr_action_menu_test.js';
  }
...
var CrElementsCheckboxTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_checkbox_test.js';
  }
};
...
var CrElementsInputTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_input_test.js';
  }
};
...
var CrElementsProfileAvatarSelectorTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_profile_avatar_selector_tests.js';
  }
};
...
var CrElementsTabsTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_tabs_test.js';
  }
};
...
var CrElementsToggleTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_toggle_test.js';
  }
};
...
var CrElementsToolbarSearchFieldTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_toolbar_search_field_tests.js';
  }
};
...
var IronListFocusTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/iron_list_focus_test.js';
  }
};
...
var CrElementsGridFocusTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_grid_focus_test.js';
  }
};
...
var CrElementsMenuSelectorFocusTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_menu_selector_focus_test.js';
  }
};
...
var CrElementsToolbarFocusTest = class extends CrElementsFocusTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=cr_elements/cr_toolbar_focus_tests.js';
  }
};
