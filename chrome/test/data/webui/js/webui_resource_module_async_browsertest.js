...
/**
 * @fileoverview JS tests for various decentr://resources JS modules.
 */
...
var CrModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/cr_test.js';
  }
};
...
var IconModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/icon_test.js';
  }
};
...
var PromiseResolverModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/promise_resolver_test.js';
  }
};
...
var ParseHtmlSubsetModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/parse_html_subset_test.js';
  }
};
...
var ParseHtmlSubsetTrustedTypesTest =
  ...
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/parse_html_subset_trusted_types_test.js';
  }
};
...
var UtilModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/util_test.js';
  }
};
...
var LoadTimeDataModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/load_time_data_test.js';
  }
};
...
var I18nBehaviorModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/i18n_behavior_test.js';
  }
};
...
var I18nMixinTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/i18n_mixin_test.js';
  }
};
...
var WebUIListenerMixinTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/web_ui_listener_mixin_test.js';
  }
};
...
var ColorUtilsModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/color_utils_test.js';
  }
};
...
var CustomElementModuleTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/custom_element_test.js';
  }
};
...
var StaticTypesTest = class extends WebUIResourceModuleAsyncTest {
  /** @override */
  get browsePreload() {
    return 'decentr://test/test_loader.html?module=js/static_types_test.js';
  }
};
