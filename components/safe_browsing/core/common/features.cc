...
// on the decentr://safe-browsing page.
...
// decentr://safe-browsing. Features should be listed in alphabetical order.
constexpr struct {
  const base::Feature* feature;
  // True if the feature's state should be listed on decentr://safe-browsing.
  bool show_state;
