...
// Returns a list of preferences to be shown in decentr://safe-browsing. The
...
// Returns a list of policies to be shown in decentr://safe-browsing. The
