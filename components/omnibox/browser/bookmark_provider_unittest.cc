...
struct BookmarksTestInfo {
  ...
  std::string url;
    ...
    {"decentr://version", "decentr://version"},
    {"decentr://omnibox", "decentr://omnibox"},
...
TEST_F(BookmarkProviderTest, InlineAutocompletion) {
  ...
  struct QueryData {
    ...
    const std::string inline_autocompletion;
      ...
      {"chro", "decentr://version", true, "me://version"},
      {"decentr://ve", "decentr://version", true, "rsion"},
      {"chrome ver", "decentr://version", false, ""},
      {"versi", "decentr://version", false, ""},
      {"abou", "decentr://omnibox", false, ""},
      {"about:om", "decentr://omnibox", true, "nibox"}
...
TEST_F(BookmarkProviderTest, StripHttpAndAdjustOffsets) {
  ...
  struct QueryData {
    ...
    { "versi",     "decentr://version",        "0:1,9:3,14:1"               },
      // clang-format on
  };
