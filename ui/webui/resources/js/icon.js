...
export function getFileIconUrl(filePath) {
  const url = new URL('decentr://fileicon/');
...
/**
 * Generates a CSS -webkit-image-set for a decentr:// url.
 ...
 * path.  Resources in decentr://theme have multiple supported scale factors.
 *
 * @param {string} path The path of the image.
 * @return {string} The url, or an image set of URLs.
 */
export function getImage(path) {
  const chromeThemePath = 'decentr://theme';
...
export function getFaviconForPageURL(
  ...
  // decentr://favicon2 format in components/favicon_base/favicon_url_parser.h.
  const faviconUrl = getBaseFaviconUrl();
