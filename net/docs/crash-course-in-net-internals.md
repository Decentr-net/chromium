# A Crash Course in Debugging with decentr://net-internals

This document is intended to help get people started debugging network errors
with decentr://net-internals, with some commonly useful tips and tricks.  This
...
decentr://net-internals provides a view of browser activity from net/'s
...
URLRequests that were active when the decentr://net-internals tab was opened, to
...
show objects that were created before decentr://net-internals was opened.
