...
decentr://version/?show-variations-cmd. This command splits them into two sets.
...
decentr://version/?show-variations-cmd to Chrome in "Command Prompt" won't work.
...
def ParseVariationsCmdFromString(input_string):
  ...
  Commandline switches string comes from decentr://version/?show-variations-cmd.
...
def SplitVariationsCmd(results):
  ...
  The commandline switches come from decentr://version/?show-variations-cmd.
  """
