...
Takes a trace from decentr://tracing and returns a Python dict containing the
...
- Collect a trace with the memory-infra category enabled (in decentr://tracing)
